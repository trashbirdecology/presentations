...
knitr::include_graphics('/images/data_flow/slide1.png')
```
...
# Data Product Flow
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('/images/data_flow/slide2.png')
```
...
# Data Product Flow
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('/images/data_flow/slide3.png')
```
...
# Data Product Flow
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('/images/data_flow/slide4.png')
```
...
# Data Product Flow
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('/images/data_flow/slide5.png')
```
...
# Data Integration
## Integrated modelling in ecology and beyond
## CDI 
