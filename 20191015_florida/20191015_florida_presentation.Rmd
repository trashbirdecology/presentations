...
institute: "Science Analytics & Synthesis | Core Science Systems<br/>U.S. Geological Survey"
...
B [label = 'Research Questions']
C [label = 'Past Research']
D [label = 'Ongoing Projects']
E [label = 'Conclusions & \nFuture Directions']
}
")
...
## define flow
{B,C,D}-> A [arrowhead = vee]

## Labels
A [label = 'Software \nDevelopment']
B [label = 'Abrupt \nChange']
C [label = 'Data \nIntegration']
D [label = 'Avian Status \nand Trends']
...
class: left, top
# Possible Titles:
- Integration in an Era of Data Abundance
- Approaches to Data Reuse and Interoperability in Ecology
